...
class MethodStateCounter:
    ...
    def invoke(self, name):
        ...
        self.invokers[name]["calls"] += 1
        # return the state of that invoker
        # return self.invokers[name]["calls"]
        return randint(5, 25)
    ...
    def get_invoker_computed(self, name):
        # return the state of the named invoker
        return self.invokers[name]["computed"]
...
@ray.remote
class PiCalculator:
    def __init__(self, task_count, sample_count, pi4_function):
        self.task_count = task_count
        self.sample_count = sample_count
        self.pi4_function = pi4_function
    ...
    def calculate(self):
        pi = (
            ...
            * sum(
                ray.get(
                    [
                        self.pi4_function.remote(self.sample_count)
...
pi_calculator = PiCalculator.remote(1000, 1000, pi4)
pi = ray.get(pi_calculator.calculate.remote())
